            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['berat']; ?></td>
                        <td><?= $row['deskripsi']; ?></td>
                        <td><img src="/assets/images/<?= $row['input_gambar']; ?>" width="60" height="90"></td>
                        <td><a href="<?= base_url('admin/delete_produk/' . $row['id']) ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
